...
#     productos= read_csv("MOCK_DATA.csv")
    ...
    # de contenedor por, tipo de contenedor y masa
    # for x in range(len(lista_tipo_cont)):
    #     main(productos, lista_tipo_cont[x][0], lista_tipo_cont[x][1], objetos_Contenedores)
    # for x in range(len(objetos_Contenedores[0])):
    #     for j in range(len(objetos_Contenedores[0][x])):
    #         for k in range(len(objetos_Contenedores[0][x][j])):
    #             print(objetos_Contenedores[x][j][k])
    ...
    # cada for es para imprimir cada tipo de contenedor con su masa recorriendo
